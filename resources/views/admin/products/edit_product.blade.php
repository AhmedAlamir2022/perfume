                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="form-sample" action="{{ route('update.product', $products->id) }}" method="post"
                                                ...
                                                <select class="form-control" name="cat_id" required>
                                                    @foreach ($categories as $category)
                                                        <option value="{{ $category->id }}"
                                                            {{ $category->id == $products->cat_id ? 'selected' : '' }}>
                                ...
                                <div class="row">
                                                ...
                                                <select class="form-control" name="brand_id" required>
                                                    @foreach ($brands as $brand)
                                                        <option value="{{ $brand->id }}"
                                                            {{ $brand->id == $brand->brand_id ? 'selected' : '' }}>
                                                            {{ $brand->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" name="size" value="{{ $products->size }}" placeholder="50 ml" class="form-control" required />
                                            </div>
                                        </div>
                                    </div>
                                </div><br>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" value="{{ $products->quantity }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" name="old_price" value="{{ $products->old_price }}"
                                                    class="form-control" required />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="number"
                                                    value="{{ $products->new_price }}" name="new_price" required />
                                            </div>
                                        </div>
                                    </div>
                                </div><br>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control" name="long_desc" rows="5" required>{{ $products->long_desc }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div><br>
